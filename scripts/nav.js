...
// When the user clicks the menu-btn, translate bars and display the dropdown
...
// When the user leaves the navbar or clicks a section-link, reset the menu-btn and dropdown
